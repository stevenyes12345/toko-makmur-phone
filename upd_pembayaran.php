...
$upd_barang= mysqli_query($koneksi,"select  *  from pembayaran where id ='$id_update_barang' ");
...
<body >
  <form action="upd_proses_pembayaran.php" method="post">
...
<td align="center" class="pink">via</td>
              <td>:</td>
          <td align="center">
              <input type="text" name="via" value="<?php echo $upd['via'];?>">
</td></tr>
<tr>
